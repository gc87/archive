...
* 先要在编译主机上编译主机版的erlang，编译主机上的erlc可以编译erl文件为beam字节码；
* 在xcomp目录钟建立目标主机的编译器连接器信息，可以直接用绝对地址设置交叉编译器；
* 尽量不要用交叉编译工具链自带的环境配置；

## 编译命令

```bash
#可选的环境变量设置，可以在conf文件内设置 export TI_SYSROOT=
CFLAGS="-O0" ./otp_build configure --xcomp-conf=./xcomp/erl-xcomp-rpi3-linux-gnueabihf.conf
make install DESTDIR=<TEMPORARY_PREFIX>
make release RELEASE_ROOT=<RELEASE_DIR> #必须是绝对目录，不然会有莫名其妙的问题出现

make release RELEASE_ROOT=/home/chun/embedded_erlang/release-rpi3
```

## 安装
```bash
 ./Install -minimal /home/pi/release-rpi3
```

## erl-xcomp-rpi3-linux-gnueabihf.conf
...
# * `CC' - C compiler.
CC=/opt/arm-bcm2708/arm-linux-gnueabihf/bin/arm-linux-gnueabihf-gcc
...
# * `CPP' - C pre-processor.
CPP=/opt/arm-bcm2708/arm-linux-gnueabihf/bin/arm-linux-gnueabihf-cpp

# * `CPPFLAGS' - C pre-processor flags.
#CPPFLAGS=

# * `CXX' - C++ compiler.
CXX=/opt/arm-bcm2708/arm-linux-gnueabihf/bin/arm-linux-gnueabihf-g++

# * `CXXFLAGS' - C++ compiler flags.
#CXXFLAGS=

# * `LD' - Linker.
LD=/opt/arm-bcm2708/arm-linux-gnueabihf/bin/arm-linux-gnueabihf-ld

# * `LDFLAGS' - Linker flags.
LDFLAGS="-L/opt/arm-bcm2708/arm-linux-gnueabihf/arm-linux-gnueabihf/sysroot/lib"
...
RANLIB=/opt/arm-bcm2708/arm-linux-gnueabihf/bin/arm-linux-gnueabihf-ranlib

# * `AR' - `ar' archiving tool.
AR=/opt/arm-bcm2708/arm-linux-gnueabihf/bin/arm-linux-gnueabihf-ar
...
erl_xcomp_sysroot="/opt/arm-bcm2708/arm-linux-gnueabihf/arm-linux-gnueabihf/sysroot"
